...
public class PantallaAccesoAlimentos extends Stage {
    ...
    public PantallaAccesoAlimentos() {
        CrearUI();
        ...
        btnAcceso.setOnAction(event -> {
            ...
            if(!listaE.isEmpty() && listaE != null) {
                ...
                if(puesto != null && puesto.equals("j") || puesto.equals("a")) {
                    ...
                    alert.setContentText("El usuario no cuenta con los permisos para acceder a la lista de alimentos");
                    alert.showAndWait();
                }
            }else {
                Alert alert = new Alert(Alert.AlertType.ERROR);
